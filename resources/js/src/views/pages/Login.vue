                        ...
                        <b-card no-body class="p-4">
                            <b-card-body>
                                <b-alert
                                    ...
                                    show
                                    variant="danger"
                                >Tài khoản hoặc mật khẩu không</b-alert>
                                <b-form>
                                    ...
                                    <b-input-group class="mb-3">
                                        ...
                                        <b-form-invalid-feedback
                                            id="email-feedback"
                                        >Bạn cần nhập một địa chỉ email</b-form-invalid-feedback>
                                    </b-input-group>
                                    <b-input-group class="mb-4">
                                        ...
                                        >Bạn chưa nhập mật khẩu</b-form-invalid-feedback>
                                    </b-input-group>
                                    <button
                                        type="submit"
...
export default {
    ...
    methods: {
        ...
        redirectAfterLogin() {
            this.$router.push(User.redirectByRole());
        }
    },
    watch: {
